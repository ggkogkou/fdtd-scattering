...
% equations
prev_step_1 = zeros(2, total_cells_y+1); % One step before values
prev_step_2 = zeros(2, total_cells_y+1); % Two steps before values
...
for t=1 : max_steps
    ...
    Ez(1, total_cells_y+1) = prev_step_1(2, total_cells_y+1) - (dx-c*dt)/(dx+c*dt)*(Ez(2, total_cells_y+1)-prev_step_1(1, total_cells_y+1));
